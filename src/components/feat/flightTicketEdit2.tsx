...
export default function FlightTicket2({
    ...
    return (
        <div
            className="relative w-full max-w-[600px] overflow-hidden rounded-xl bg-gradient-to-r from-blue-600 to-blue-800 p-1 text-white shadow-lg"
